...
if (isset($_POST['submit'])) {
    ...
    if ($courseId == null && $courseName == null && $shortName == null) {
        echo "<script>alert('All filled required to filled');</script>";
    } else {


        $query = "INSERT INTO tbl_course (courseId,courseName,shortName) 
        VALUES ('$courseId', '$courseName', '$shortName')";
        echo $query;

        $data = mysqli_query($conn, $query);

        if ($data != null) {
            echo "<script>alert('Student Courses Created ');</script>";
        } else {
            echo "<script>alert('fail to Create Courses');</script>";
        }
    }
